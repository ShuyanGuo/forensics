...
7. Some incriminating evidence could be all of the pictures, list of upcoming tour dates and the videos (including an encrypted video) of Lady Gaga on the disk and also the fact that there are pdf files that explain how to use sqlmap to exploit a sql injection vulnerability.
